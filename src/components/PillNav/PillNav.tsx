...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="absolute top-[1em] z-[1000] w-full left-0 md:w-auto md:left-auto">
            ...
            {items.map((item, i) => {
              ...
              const PillContent = (
                <>
                  ...
                  {isActive && (
                    <span
                      className="absolute left-1/2 -bottom-[6px] -translate-x-1/2 w-3 h-3 rounded-full z-[4] bg-black"
                      aria-hidden="true"
                    />
                  )}
                </>
      ...
      <div
        ref={mobileMenuRef}
        className="md:hidden absolute top-[3em] left-4 right-4 rounded-[27px] shadow-lg z-[998] origin-top bg-gray-100"
      >
